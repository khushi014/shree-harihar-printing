...
const strongValues = [
  ...
  },
  {
    ...
    img: "/images/factory_team_craft.jpg"
  },
  {
    id: "03",
          ...
          <div className="hidden lg:flex w-[40%] sticky top-32 justify-center items-center h-150 z-20">
            <div className="relative w-full h-full flex justify-center items-center">
              {strongValues.map((val, idx) => (
                <div
                  key={idx + "img"}
                  className={`absolute w-[90%] sm:w-[80%] lg:w-[90%] max-w-[450px] aspect-[4/5] sm:aspect-square shadow-2xl p-3 bg-white transform transition-all duration-700 ease-out origin-center ${activeIndex === idx
