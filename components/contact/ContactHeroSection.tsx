...
export default function ContactHeroSection() {
  return (
    <section className="bg-slate-900 border-b border-primary/20 text-white py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-[url('https://images.unsplash.com/photo-1596524430615-b46475ddff6e?auto=format&fit=crop&q=80&w=1600')] bg-cover bg-center opacity-10 filter grayscale"></div>
