  ...
  return (
    <section id="contact" className="bg-white relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-[#1E1E1E] py-20 lg:py-28 flex flex-col justify-between">
            ...
            <div className="mb-12">
              ...
              <h2 className="font-heading text-[2rem] sm:text-[2.75rem] lg:text-[3rem] leading-[1.1] text-white mb-6">
                Let&apos;s talk about{" "}
